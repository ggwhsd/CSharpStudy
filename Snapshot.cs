...
namespace UITest
{
    public partial class Snapshot : Form
    {
        ...
        private void Snapshot_Load(object sender, EventArgs e)
        {
            ...
            //originBmp.Save("snapshotGreen.jpg");
        }

        private void Snapshot_MouseClick(object sender, MouseEventArgs e)
        {
        ...
        private void Snapshot_MouseCaptureChanged(object sender, EventArgs e)
        {

        }

        private void Snapshot_MouseDoubleClick(object sender, MouseEventArgs e)
        {
