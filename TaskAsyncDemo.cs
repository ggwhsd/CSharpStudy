...
namespace MarketRiskUI
{
    ...
    {
        private int i = 0;
        public bool GetSomeThing(string a)
        {
        ...
        //封装成Task，才能使用Task异步编程
        public Task<bool> GetSomeThingAsync(string a)
        {
        ...
        public async  void ConsumeManyTime()
        {
        ...
        public  void ContinueTaskWithConsumeManyTime()
        {
        ...
        //方式3：多任务等待方式
        public async void TaskWhenConsumeManyTime()
        {
            Task<bool> t1 = GetSomeThingAsync("test");
        ...
        public void Testpallral()
        {
            ParallelLoopResult result =

                  System.Threading.Tasks.Parallel.For(0, 100, async (int i) =>
        ...
        public void Testpallral2()
        {
            ParallelLoopResult result =
                  System.Threading.Tasks.Parallel.For(0, 100, async (int i, ParallelLoopState pls) =>
                  {
                      Console.WriteLine(DateTime.Now.ToLongTimeString() + "{0}, task: {1}, thread: {2}", i,
                      Task.CurrentId, Thread.CurrentThread.ManagedThreadId);
